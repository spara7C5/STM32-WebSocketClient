...
#define NIC_TRACE_LEVEL          2//4
#define ETH_TRACE_LEVEL          1//2
#define ARP_TRACE_LEVEL          1//2
#define IP_TRACE_LEVEL           1//2
#define IPV4_TRACE_LEVEL         1//2
#define IPV6_TRACE_LEVEL         1//2
#define ICMP_TRACE_LEVEL         1//2
#define IGMP_TRACE_LEVEL         1//2
#define ICMPV6_TRACE_LEVEL       1//2
#define MLD_TRACE_LEVEL          1//2
#define NDP_TRACE_LEVEL          1//2
#define UDP_TRACE_LEVEL          1//2
#define TCP_TRACE_LEVEL          1//2
#define SOCKET_TRACE_LEVEL       1//2
#define RAW_SOCKET_TRACE_LEVEL   1//2
#define BSD_SOCKET_TRACE_LEVEL   1//2
#define WEB_SOCKET_TRACE_LEVEL   5//4
#define AUTO_IP_TRACE_LEVEL      2//4
#define SLAAC_TRACE_LEVEL        2//4
#define DHCP_TRACE_LEVEL         2//4
#define DHCPV6_TRACE_LEVEL       4
#define DNS_TRACE_LEVEL          2//4
#define MDNS_TRACE_LEVEL         2
#define NBNS_TRACE_LEVEL         2
#define LLMNR_TRACE_LEVEL        2
#define COAP_TRACE_LEVEL         4
#define FTP_TRACE_LEVEL          2//5
